...
function applyBranding(doc: PDFDocument, branding: ReportBranding | null): void {
  const brand = branding ?? {
    ...
    footerText: "Generated by ABeam - SAP S/4HANA Cloud Assessment Platform",
    companyName: null,
    logoUrl: null,
  };

  // Header: partner logo (left) + "ABeam" wordmark (right)
  if (brand.logoUrl) {
...
| Organization has no branding configured | Use default branding (ABeam logo, default colors, default footer) |
...
const sampleBranding = {
  ...
  footerText: "Confidential - Prepared by ABeam Consulting",
  companyName: "ABeam Consulting Pte. Ltd.",
...
Then the PDF header includes the partner logo (left) and "ABeam" wordmark (right)
