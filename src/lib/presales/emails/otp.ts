...
<html lang="en">
<head><meta charset="UTF-8" /><title>ABeam Workbench verification code</title></head>
<body style="margin:0;background:#F8FAFC;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;color:#1A1A1A">
  ...
  const text = `ABeam Workbench verification code
...
— ABeam Workbench`;
  ...
  return {
    ...
    subject: 'ABeam Workbench verification code',
    html,
    text,
  };
}
