...
export default function InvitationAcceptPage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 text-center space-y-4">
      ...
      {status === "success" && result && (
        <>
          ...
          <h2 className="text-lg font-semibold text-foreground">Welcome to {result.organization.name}!</h2>
