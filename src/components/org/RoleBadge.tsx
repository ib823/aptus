...
const ROLE_COLORS: Record<UserRole, string> = {
  ...
  partner_lead: "bg-indigo-100 text-indigo-700",
  consultant: "bg-blue-100 text-blue-700",
  project_manager: "bg-cyan-100 text-cyan-700",
  solution_architect: "bg-teal-100 text-teal-700",
  process_owner: "bg-green-100 text-green-700",
  it_lead: "bg-amber-100 text-amber-700",
  data_migration_lead: "bg-orange-100 text-orange-700",
  executive_sponsor: "bg-rose-100 text-rose-700",
  viewer: "bg-gray-100 text-gray-700",
  client_admin: "bg-pink-100 text-pink-700",
};
