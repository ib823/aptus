...
export const ONBOARDING_FLOWS: Record<UserRole, OnboardingFlow> = {
  platform_admin: {
    ...
    description: "Set up and manage ABeam platform.",
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam administration.", isRequired: true, action: { type: "none" } },
  ...
  partner_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Partner Lead.", isRequired: true, action: { type: "none" } },
  ...
  consultant: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Consultant.", isRequired: true, action: { type: "none" } },
  ...
  project_manager: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Project Manager.", isRequired: true, action: { type: "none" } },
  ...
  solution_architect: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Solution Architect.", isRequired: true, action: { type: "none" } },
  ...
  process_owner: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Process Owner.", isRequired: true, action: { type: "none" } },
  ...
  it_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as an IT Lead.", isRequired: true, action: { type: "none" } },
  ...
  data_migration_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Data Migration Lead.", isRequired: true, action: { type: "none" } },
  ...
  executive_sponsor: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as an Executive Sponsor.", isRequired: true, action: { type: "none" } },
  ...
  viewer: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam.", isRequired: true, action: { type: "none" } },
  ...
  client_admin: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to ABeam as a Client Admin.", isRequired: true, action: { type: "none" } },
...
export const TOOLTIP_REGISTRY: TooltipRegistryEntry[] = [
  ...
  { key: "fit_gap_classification", title: "Process Classification", content: "For each process step, indicate whether SAP's best practice matches your process, needs configuration adjustments, doesn't match, or doesn't apply.", placement: "right", targetSelector: "[data-tooltip='classification']" },
