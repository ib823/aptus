...
export const ONBOARDING_FLOWS: Record<UserRole, OnboardingFlow> = {
  platform_admin: {
    ...
    description: "Set up and manage Aptus platform.",
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus administration.", isRequired: true, action: { type: "none" } },
  ...
  partner_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Partner Lead.", isRequired: true, action: { type: "none" } },
  ...
  project_manager: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Project Manager.", isRequired: true, action: { type: "none" } },
  ...
  solution_architect: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Solution Architect.", isRequired: true, action: { type: "none" } },
  ...
  process_owner: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Process Owner.", isRequired: true, action: { type: "none" } },
  ...
  it_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as an IT Lead.", isRequired: true, action: { type: "none" } },
  ...
  data_migration_lead: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Data Migration Lead.", isRequired: true, action: { type: "none" } },
  ...
  executive_sponsor: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as an Executive Sponsor.", isRequired: true, action: { type: "none" } },
  ...
  viewer: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus.", isRequired: true, action: { type: "none" } },
  ...
  client_admin: {
    ...
    steps: [
      { index: 0, title: "Welcome", description: "Welcome to Aptus as a Client Admin.", isRequired: true, action: { type: "none" } },
